...
const api: ElectronAPI = {
  ...
  getMobileServerEnabled: () => ipcRenderer.invoke("get-mobile-server-enabled"),
  setMobileServerEnabled: (enabled) => ipcRenderer.invoke("set-mobile-server-enabled", enabled),
