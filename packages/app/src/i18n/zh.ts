...
export const dict = {
  ...
  "prompt.action.enhance": "优化输入",
  "prompt.action.enhancing": "优化中...",
  "prompt.toast.enhanceFailed.title": "优化输入失败",
  ...
  "settings.general.row.mobileServer.title": "手机端访问",
  "settings.general.row.mobileServer.description": "允许手机和局域网设备连接桌面端服务。需要重启后生效。",
